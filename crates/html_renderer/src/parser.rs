...
fn classify(tag: &str) -> TagKind {
    match tag.to_lowercase().as_str() {
        ...
        "tr" => TagKind::Block(BlockTag::Tr),
        "td" => TagKind::Block(BlockTag::Td),
        "th" => TagKind::Block(BlockTag::Th),
        "thead" => TagKind::Block(BlockTag::Thead),
        "tbody" => TagKind::Block(BlockTag::Tbody),
